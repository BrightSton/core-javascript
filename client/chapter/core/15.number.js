...
// 숫자 옆에 `e`(exponential)를 붙여 0의 갯수를 설정할 수 있습니다.
riches = 1e8;
...
console.log("pow : ", pow); // -> 900719925470992

// 최소, 최대 값 사이 난수 반환 함수
let getRandomMinMax = (min, max) => {
  if (min > max) throw new Error("최솟값은 최대값보다 작아야합니다.");
