...
// 배열 선언
// let friends = ["일범", "성욱", "보경", "서현", "세은 "];
let friends = "일범,성욱,보경,서현,세은,선희,대응,아현,동경".split(",");
console.log(friends);
...
// 배열 요소 추가
let unshift = friends.unshift("보영"); // -> 배열 맨 앞에 추가
let push = friends.push("원준"); // -> 배열 맨 뒤에 추가

// 배열 요소 제거
let shift = friends.shift(); // -> 배열 맨 앞에 제거하고 도출
let pop = friends.pop(); // -> 배열 맨 뒤에 제거하고 도출
